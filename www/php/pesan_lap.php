<?php 
	...
	while ($data = mysqli_fetch_assoc($q)) {
		$url = 'http://aplikasifutsal.000webhostapp.com/php/aksi_pesan.php';
		echo "
		<form method='post' action=$url class='form-user'>
			<div class='form-group'>
				<label>Nama Lengkap</label>
				<input type='text' name='username' class='form-control user' value='$data[username]' readonly>
			</div>
			<div class='form-group'>
				<label>Email</label>
			...
			<div class='form-group'>
				...
				<input type='text' class='form-control' name='id_lap' value='1'>
			</div>

			<label>Jam</label> "; ?>
			<div>
				<select name="jam_mulai" id="mulai" class='form-control'>
			...
			<div>
				<select name="jam_selesai" id="selesai" class="form-control">
			...
			<div class='form-group'>
				<label>Harga</label>
				<input class='form-control harga' name='harga' id='harga' type='text'>
			</div>
			<script>
